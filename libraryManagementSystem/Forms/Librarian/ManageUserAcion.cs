...
{
    public partial class ManageUserAcion : Form
    {
        public ManageUserAcion()
        {
            InitializeComponent();
        }
        ...
        {
            dgv_logs.DataSource = logService.getAllUserActions();
        }
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            List<Log> searchResults = logService.SearchUserActionLogs(bookName, userName);
